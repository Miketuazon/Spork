...
const Feed = () => {
  ...
  return (
    <div className='Feed'>
      <ul class="post-types">
        <li>
          {/* <OpenModalButton className="post-type-btn modal-button text-btn post-type-icon" aria-label="Text" buttonText={<><i className="fas fa-font"></i></>} modalComponent={<CreateLinkPost />}>
            Text
          </OpenModalButton> */}
          <OpenModalButton className="post-type-btn modal-button text-btn post-type-icon" aria-label="Text" buttonText={<><i className="fas fa-font"></i></>}>
