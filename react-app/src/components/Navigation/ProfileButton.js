            ...
            <div className="options-for-drop-down">
              <ul>
                <div className="top-dropdown-menu-options">
                  ...
                  <li onClick={() => window.location.href = "/following"}>
                  <i className="fas fa-user-friends following-btn"></i> Following
                  {user?.following?.length > 0 ? Number(user?.following?.length) : null}
                  </li>

                <li className="fas fa-users">
                 Followers {user?.followers?.length ? followCount : null}
                </li>

                 <li onClick={() => window.location.href = '/Likes'}> <i className="fas fa-heart"></i> Likes</li>
                 <li onClick={() => window.location.href = '/adfree'}><i className="fas fa-ad"></i> Ad-Free</li>
                 <li onClick={() => window.location.href='/gifts'}><i className="fas fa-gift"></i> Gifts</li>
                 <li onClick={() => window.location.href='/livestreamcredits'}><i class='fas fa-coins'></i> Live Streaming Credits</li>
                <li button className="popup-btn" onClick={() => alert('Settings feature coming soon, sorry!')}><i className="fas fa-cog"></i> Settings</li>
                <li className="popup-btn" onClick={() => alert('Change Palette feature coming soon, sorry!')}>
               <i className="fas fa-palette"></i> Change Palette </li>
              <li className="popup-btn" onClick={() => alert('Keybord Shortcuts feature coming soon, sorry!')}>
              <i className="fas fa-keyboard"></i> Keyboard Shortcuts</li>
              <li className="popup-btn" onClick={() => alert('Help feature coming soon, sorry!')}><i className="fas fa-question-circle"></i> Help</li>
              <li className="popup-btn" onClick={() => alert('Whats New feature coming soon, sorry! ')}><i className="fas fa-bullhorn"></i> What's New</li>
