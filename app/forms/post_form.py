...
class PostForm(FlaskForm):
    ...
    content = StringField('content', validators=[DataRequired(message='Content is required!'), Length(min=3,max=256, message='Content must be between 3 and 255 characters')] )
